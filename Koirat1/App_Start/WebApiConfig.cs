...
namespace Koirat1
{
    //tän piti tehdä exceli-muotoon koko jutun, muttei tehnyt. Täytyy tutkia vielä. 
    /*
    public class CSVMediaTypeFormatter : MediaTypeFormatter
    {
        ...
        protected Task OnWriteToStreamAsync(
               Type type,
               object value,
               Stream stream,
    ...
    */
    ...
    public static class WebApiConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            //Jos hakee api/koirat?format=csv antaa error 500?
            //config.Formatters.Remove(config.Formatters.XmlFormatter); poistaa xml:än ja näyttää json-tiedostomuodossa
        }
    }
}
